...
from keras.layers import Input, Conv2D, Lambda, Concatenate, Reshape, Permute, DepthwiseConv2D, Add, Dense
...
def dl_model():
    ...
    def block_1(input_tensor):
        ...
        conv_1 = Conv2D(input_channels // 3, kernel_size=(1, 1), strides=(1, 1), padding='same', activation='relu')(input_groups[0])
        conv_2 = Conv2D(input_channels // 3, kernel_size=(1, 1), strides=(1, 1), padding='same', activation='relu')(input_groups[1])
        conv_3 = Conv2D(input_channels // 3, kernel_size=(1, 1), strides=(1, 1), padding='same', activation='relu')(input_groups[2])
    ...
    depthwise_conv_output = DepthwiseConv2D(kernel_size=(3, 3), strides=(1, 1), padding='same', activation='relu')(block_2_output)
